package com.hxcel.globalhealth.cms;
...
import com.hxcel.globalhealth.cms.utils.HttpAnyMethod;
...
public class CmsServiceImpl implements CmsService {
    ...
    public Boolean isAvailable() {
        ...
        if (log.isTraceEnabled()) {
            if (result) {
                log.trace("The Sling Content Management System is operational");
            } else {
                log.trace("The Sling Content Management System is not ready. Make sure Sling is running and you are pointing to the URL Sling is running on");
            }
        }
