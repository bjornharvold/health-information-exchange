...
import com.hxcel.globalhealth.platform.spec.model.enums.CreditcardTypeCd;
...
@TypeDefs(
        ...
        @TypeDef(name = "cctype",
                ...
                parameters = {@Parameter(name = "enumClassName", value = "com.hxcel.globalhealth.user.model.enums.CreditcardTypeCd")}
        ),
        @TypeDef(
