...
public abstract class AbstractConverter implements CustomConverter {
    ...
    public Object convert(Object destination, Object source, Class destClass, Class sourceClass) {
        ...
        try {
            if (source instanceof AbstractEntity) {
                ...
                if (destination == null) {
                    try {
                        dto = (IAbstractDto) destClass.newInstance();
                ...
                return dto;
            } else if (source instanceof IAbstractDto) {
                dto = (IAbstractDto) source;
     ...
     * @return
     */
    protected abstract IAbstractDto toDto(IAbstractDto dto, AbstractEntity source, Class destClass, Class sourceClass);
     ...
     * @return
     */
    protected abstract AbstractEntity toEntity(AbstractEntity entity, IAbstractDto source, Class destClass, Class sourceClass);
