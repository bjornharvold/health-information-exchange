...
import org.apache.tiles.servlet.context.ServletTilesApplicationContextFactory;
...
public class SpringTilesConfigurer implements ServletContextAware, InitializingBean, DisposableBean {
    ...
    private final static Logger log = LoggerFactory.getLogger(SpringTilesConfigurer.class);
    ...
    public void setDefinitions(String[] definitions) {
        if (definitions != null) {
            ...
            if (log.isInfoEnabled()) {
                log.info("TilesConfigurer: adding definitions [" + defs + "]");
            }
