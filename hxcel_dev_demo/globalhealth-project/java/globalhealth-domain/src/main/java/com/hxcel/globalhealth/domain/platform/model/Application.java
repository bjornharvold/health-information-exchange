...
@TypeDefs(
        {
            @TypeDef(name = "applicationStatus",
                    ...
                    parameters = {@Parameter(name = "enumClassName", value = "com.hxcel.globalhealth.domain.platform.model.enums.ApplicationStatusCd")}
            ),
            @TypeDef(name = "applicationType",
                    typeClass = EnumUserType.class,
                    parameters = {@Parameter(name = "enumClassName", value = "com.hxcel.globalhealth.domain.platform.model.enums.ApplicationTypeCd")}
            )
                }
)
@Entity
