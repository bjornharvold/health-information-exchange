...
@TypeDefs(
        ...
        @TypeDef(name = "salutation",
                ...
                parameters = {@Parameter(name = "enumClassName", value = "com.hxcel.globalhealth.domain.common.model.enums.SalutationCd")}
        ),
        @TypeDef(name = "sex",
                typeClass = com.hxcel.globalhealth.domain.utils.hibernate.type.EnumUserType.class,
                parameters = {@Parameter(name = "enumClassName", value = "com.hxcel.globalhealth.domain.common.model.enums.SexCd")}
        ),
        @TypeDef(
