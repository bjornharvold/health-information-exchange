...
import com.hxcel.globalhealth.domain.socialnetwork.dao.PublicProfileDAO;
...
public class PublicProfileDAOHibernate extends AbstractHibernateDAO<PublicProfile, String> implements PublicProfileDAO {
    private static final Logger log = LoggerFactory.getLogger(PublicProfileDAOHibernate.class);
