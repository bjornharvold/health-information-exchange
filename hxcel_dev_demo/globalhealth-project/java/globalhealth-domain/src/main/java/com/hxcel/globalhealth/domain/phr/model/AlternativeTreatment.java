...
@TypeDefs(
        ...
        @TypeDef(name = "alternativeTreatmentType", typeClass = EnumUserType.class, parameters = {
        @Parameter(name = "enumClassName", value = "com.hxcel.globalhealth.domain.phr.model.enums.AlternativeTreatmentTypeCd")
                }),
...
public class AlternativeTreatment extends AbstractPhrEntity implements Serializable {
    ...
    @Type(type = "alternativeTreatmentType")
    public AlternativeTreatmentTypeCd getAlternativeTreatmentTypeCd() {
        return this.alternativeTreatmentTypeCd;
    }


    public void setAlternativeTreatmentTypeCd(AlternativeTreatmentTypeCd value) {
        this.alternativeTreatmentTypeCd = value;
    }
    ...
    public String getAlternativeTreatmentOther() {
        return this.alternativeTreatmentOther;
    }


    public void setAlternativeTreatmentOther(String value) {
        this.alternativeTreatmentOther = value;
    }
